within OpenIPSL.Electrical.GFCs.GFMs.REGFMA1.TestComponents.REGFM_A1_with_Limiters;
model Components_unpackaged_system_test
  ...
  Modelica.Blocks.Sources.RealExpression sig_V0(y=VS.vt0) annotation (
      Placement(transformation(
        ...
        rotation=180,
        origin={-198,174})));
  REGFMA1.LimitersAndCntrlSchemes.Plimiter plimiter
    annotation (Placement(transformation(extent={{-260,-100},{-220,-140}})));
  BasicComponentsAndCntrlSchemes.LPFilter Pfilt
  ...
  REGFMA1.LimitersAndCntrlSchemes.Qlimiter qlimiter
  ...
  BasicComponentsAndCntrlSchemes.LPFilter Qfilt(y0val=5.416582/100)
