...
model qv_droop_scheme_qvflag_0_vflag_0
  "Tests the qv_droop_scheme with QVFLAG = 0 and VFLAG = 0"
  extends Modelica.Icons.Example;
  OpenIPSL.Electrical.GFCs.GFMs.BasicComponentsAndCntrlSchemes.qv_droop_scheme_nolims
    q_v_droop_scheme(QVFlag_val_k=false, VFlag_val_k=false)
...
end qv_droop_scheme_qvflag_0_vflag_0;
