within OpenIPSL.Electrical.GFCs.GFMs.CntrlSchemeComponents;
model VSIO_for_GFM
  ...
  Modelica.Blocks.Sources.Constant E0meas(k=VS.E0)
    "Internal voltage magnitude start value"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=270,
        origin={-80,-50})));
  Modelica.Blocks.Sources.Constant delta0meas(k=VS.delta0)
    "Internal voltage angle start value"
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=270,
        origin={-40,-50})));
...
//     annotation (Dialog(group="Opal-RT PF and Other Params."));
//   parameter Integer IBUS=100 "Located system bus"
//     annotation (Dialog(group="Opal-RT PF and Other Params."));
//   parameter Real P_gen=40.0 "Bus Active Power, MW"
//     annotation (Dialog(group="Opal-RT PF and Other Params."));
//   parameter Real Q_gen=5.416582 "Bus Reactive Power, MVAR"
//     annotation (Dialog(group="Opal-RT PF and Other Params."));
//   parameter Real Vt_abs=1.0 "Bus Voltage Magnitude, p.u."
//     annotation (Dialog(group="Opal-RT PF and Other Params."));
//   parameter Real Vt_ang=4.038907 "Bus Voltage Angle, deg."
//     annotation (Dialog(group="Opal-RT PF and Other Params."));
...
//     annotation (Dialog(group="Opal-RT PF and Other Params."));
  ...
  Modelica.Blocks.Interfaces.RealOutput vt0 "Connector of Real output signal"
    annotation (Placement(transformation(
        ...
        rotation=270,
        origin={70,-110})));
  parameter Types.ApparentPower S_b=VS.SysData.S_b "System base power"
...
equation
  ...
  connect(E0meas.y, E0) annotation (Line(points={{-80,-61},{-80,-110}},
                                 color={0,0,127}));
  connect(delta0meas.y, delta0) annotation (Line(points={{-40,-61},{-40,-110}},
                                       color={0,0,127}));
  connect(p0meas.y, p0)
  ...
  connect(VS.p, p1)
    annotation (Line(points={{22,0},{22,0},{110,0}},   color={0,0,0}));
